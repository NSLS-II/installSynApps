...
class ConfigInjector:
    ...
    def inject_to_file(self, injector_file):
        ...
        with open(target_path, "a") as target_fp:
    ...
    def update_macros_dir(self, macro_replace_list, target_dir, force_override_comments=False):
        ...
        if os.path.exists(target_dir) and os.path.isdir(target_dir):
            for file in os.listdir(target_dir):
                if os.path.isfile(os.path.join(target_dir, file)) and not file.endswith(".pl") and file != "Makefile" and not file.endswith(".ioc"):
    ...
    def update_macros_file(self, macro_replace_list, target_dir, target_filename, comment_unsupported = False, with_ad = True, force=False):
        ...
        with open(os.path.join(old_files_dir, target_filename), "r") as old_fp:

            new_file = installSynApps.join_path(target_dir, target_filename)
            if target_filename.startswith("EXAMPLE_"):
               new_file = installSynApps.join_path(target_dir, target_filename[8:])
