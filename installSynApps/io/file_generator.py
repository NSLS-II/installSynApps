...
class FileGenerator:
    ...
    def generate_readme(self, installation_name, installation_type='source', readme_path=None, module=None, lean_grab=False):
        ...
        if readme_path is None:
            if os.path.exists(installSynApps.join_path(self.install_config.install_location, 'INSTALL_README.txt')):
                os.remove(installSynApps.join_path(self.install_config.install_location, 'INSTALL_README.txt'))
            readme_fp = open(installSynApps.join_path(self.install_config.install_location, 'INSTALL_README.txt'), 'w')
