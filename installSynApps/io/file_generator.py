...
class FileGenerator:
    ...
    def generate_remake_sources(self):
        ...
        regenerate_fp = open(os.path.join(self.install_config.install_location, 'autogenerated', 'regenerateSources.sh'), 'w+')
        ...
        regenerate_fp.write('./installCLI.py -i {} -c {} -p -y\n\n'.format(os.path.join(abs_loc, 'regenerated'), os.path.join(abs_loc, 'build-config')))
        regenerate_fp.close()
