...
class ScriptGenerator:
    ...
    def initialize_dir(self):
        ...
        if os.path.exists(self.install_config.install_location + "/autogenerated/"):
            shutil.rmtree(self.install_config.install_location + "/autogenerated/")
        
        os.mkdir(self.install_config.install_location + "/autogenerated")
